...
const widgetsCardChart1 = document.getElementById("widgets-card-chart1");
if (widgetsCardChart1) {
  // eslint-disable-next-line no-unused-vars
  const cardChart1 = new Chart(widgetsCardChart1, {
    type: "line",
    data: {
...
const widgetsCardChart2 = document.getElementById("widgets-card-chart2");
if (widgetsCardChart2) {
  // eslint-disable-next-line no-unused-vars
  const cardChart2 = new Chart(widgetsCardChart2, {
    type: "line",
    data: {
      labels: ["January", "February", "March", "April", "May", "June", "July"],
      datasets: [
...
const widgetsCardChart3 = document.getElementById("widgets-card-chart3");
if (widgetsCardChart3) {
  // eslint-disable-next-line no-unused-vars
  const cardChart3 = new Chart(widgetsCardChart3, {
    type: "line",
    data: {
      labels: ["January", "February", "March", "April", "May", "June", "July"],
      datasets: [
...
const widgetsCardChart4 = document.getElementById("widgets-card-chart4");
if (widgetsCardChart4) {
  // eslint-disable-next-line no-unused-vars
  const cardChart4 = new Chart(document.getElementById("widgets-card-chart4"), {
    type: "bar",
    data: {
      labels: [
        "January",
